class ProfileLayoutsController < ApplicationController
  ...
  def profile_songs
	...
	def field_update
      ...
      if params[:field][:field_name] == "p_size"
        ...
        @white_list = ["logo_font","content_font","h1_colour","h2_colour","h3_colour","p_colour","div_1_colour","div_1_transparency","div_1_border_colour","div_1_background_colour","div_1_border_width","div_2_colour","div_2_transparency","div_2_border_colour","div_2_background_colour","div_2_border_width","background_colour"]
  ...
  def save_colour_theme(artist, theme_name)
    ...
    if theme_name == "theme_1"
      ...
      @artist.profile_layout.div_1_background_colour = "#A8BFBD"
      ...
      @artist.profile_layout.div_1_background_colour = "#C1D1DE"
    ...
    @artist.profile_layout.logo_colour = "#FFFFFF"
    @artist.profile_layout.div_1_colour = "#FFFFFF"
    @artist.profile_layout.div_1_background_colour = "#BFBFBF"
    ...
    @artist.profile_layout.nav_hover_colour = "#E6E632"
      ...
      @artist.profile_layout.logo_colour = "#FFFFFF"
      @artist.profile_layout.div_1_colour = "#FFFFFF"
      @artist.profile_layout.div_1_background_colour = "#5F7A87"
      @artist.profile_layout.call_to_action_colour = "#D9302E"
