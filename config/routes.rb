Music3::Application.routes.draw do
  ...
  match  "privacy_policy" => "homepage#privacy_policy", :as => :privacy_policy
   ...
   match "/go_suck_a_fucking_dick/rails_forms_are/dumb_cunts" => "profile_layouts#update_profile_layout"
    ...
    match "users/update_password" => "users#update_password", :as => "update_password_custom"
	...
	match "/:url_slug/profile-edit/song/:song_url_slug" => "profile_layouts#edit", :as => :profile_edit_song
  match "/:url_slug/profile-edit/album/:album_url_slug" => "profile_layouts#edit", :as => :profile_edit_album
  match "/:url_slug/profile-edit/songs" => "profile_layouts#edit", :as => :profile_songs
  ...
  match "/:url_slug/download-csv/:id" => "album_code#album_codes_csv", :as => :album_codes_csv
	...
	match "/:url_slug/download-code" => "albums#download_code_redemption", :as => :album_code_download
	match "/:url_slug/album_code_find" => "albums#album_code_find", :as => :find_album_code



  #field save routing
  match "/:url_slug/update_field/profile" => "profile_layouts#field_update", :as => :profile_layout_field_update
  match "/:url_slug/update_field/artist" => "artists#field_update", :as => :artist_field_update
