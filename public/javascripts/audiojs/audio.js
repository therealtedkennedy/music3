 (function (h, o, g) {
     ...
     g[h] = {
         ...
         settings: {
             ...
             createPlayer: {
                 markup: '   <div class ="image">       <div class="play-pause">             <h3 class="play">Play</h3>                        <h3 class="pause">Pause</h3>             <h3 class="loading">Loading</h3>             <h3 class="error">Error</h3>           </div> <div class="time">             <em class="played">00:00</em>/<strong class="duration">00:00</strong>           </div>     </div>        <div class="scrubber">             <div class="progress"></div>             <div class="loaded"></div>           </div>                    <div class="error-message"></div>',
