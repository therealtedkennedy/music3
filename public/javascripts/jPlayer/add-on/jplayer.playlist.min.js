...
(function (b, f) {
    ...
    jPlayerPlaylist.prototype = {
        ...
        _createListItem: function (a) {
            var c = this,
                d = "<li style='width:auto; float:left; margin-right: 30px;'><div>";
            ...
            d += "<span class='imageHover'>";

            d += "<a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "'><img src='"+ a.albumArt+"' class='img100 playable'/></a><a href='javascript:;' class='" + this.options.playlistOptions.itemClass + " plText' tabindex='1'><div class='wrapper'>" + a.title + "</div></a>" + (a.artist ? "<a href='#' class='jp-artist plText'><div class='wrapper'>" + a.artist + "</div></a>" : "");

            d += "<div class='hoverPlay'><span></span></div>";
            d += "</span>";
            d += "</div></li>";
            return d
        },
...
adfadfadsfadsfasdfasdfadsfasdfjaskl;dfadslkfja