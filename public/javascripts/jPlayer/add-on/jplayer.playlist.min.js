...
(function (b, f) {
    ...
    jPlayerPlaylist.prototype = {
        ...
        _createListItem: function (a) {
            ...
            d += "<img src='"+ a.src+"' style='width:100px;height:100px;'/><a href='javascript:;' class='" + this.options.playlistOptions.itemClass + "' tabindex='1'><div class='wrapper'>" + a.title + "</div></a>" + (a.artist ? "<a href='#' class='jp-artist'><div class='wrapper'>" + a.artist + "</div></a>" : "");
            d += "</div></li>";
            return d
        },
